...
if __name__ == "__main__":
    ...
    category = 'car'
    IMG_DIR = "./dataset/{}/images".format(category)      #图片文件夹路径
    XML_DIR = "./dataset/{}/annotations".format(category)     #xml文件夹路径

    AUG_IMG_DIR = "./dataset/{}/images_aug".format(category)  # 存储增强后的影像文件夹路径
    AUG_XML_DIR = "./dataset/{}/annotations_aug".format(category)  # 存储增强后的XML文件夹路径
