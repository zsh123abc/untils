...
def xml_to_csv(group_path, result_path):
...
def convert(group_path):
    ...
    for result_path in group_result_paths:
        if result_path != 'info':
            continue
        xml_to_csv(group_path, result_path)


def convert_groups(groups_path):
    for group_path in os.listdir(groups_path):
        ...
        if os.path.isdir(path_):
            if group_path != 'info':
                ...
                xml_to_csv(groups_path, group_path)
