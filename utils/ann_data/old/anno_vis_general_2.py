...
if __name__ == '__main__':
    ...
    edges = [[0, 1], [1, 2], [2, 4], [4, 6], [1, 3], [3, 5], [5, 7], [8, 10], [10, 12], [9, 11], [11, 13],
             [8, 9], [2, 8], [3, 9]]
    json_path = 'C:/Users/dell/Desktop/fsdownload/pull-up10_13/annotations/pull-up.json' # json路径
    ...
    for i in data:
        ...
        #     continue
        kps = i['points']
        img = cv2.imread(os.path.join('C:/Users/dell/Desktop/fsdownload/pull-up10_13/', img_path)) #图片上两级路径
        ...
        output_path = 'C:/Users/dell/Desktop/fsdownload/pull-up10_13/img'
